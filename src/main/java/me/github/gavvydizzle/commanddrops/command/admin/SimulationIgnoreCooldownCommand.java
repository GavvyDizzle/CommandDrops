...
public class SimulationIgnoreCooldownCommand extends SubCommand implements WildcardCommand {
    ...
    public SimulationIgnoreCooldownCommand(AdminCommandManager adminCommandManager, PlayerManager playerManager, RewardManager rewardManager) {
        this.playerManager = playerManager;
        this.rewardManager = rewardManager;

        setName("simulateIgnoreCooldown");
        setDescription("Simulate reward events while ignoring all cooldown logic");
        setSyntax("/" + adminCommandManager.getCommandDisplayName() + " simulateIgnoreCooldown <type> <poolID> <player> <amount>");
    ...
    public void perform(CommandSender sender, String[] args) {
        ...
        if (args[1].equalsIgnoreCase("attempt")) {
            ...
            pool.attemptWithoutEventIgnoreCooldowns(lp, amount);
